        ...
        <div className="card-deck">
          <div className="card" style={{ width: "18rem" }}>
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                Explore nearby local and national parks.{" "}
              </p>
              <a
                href={`/cities/${this.props.city.id}/parks`}
          ...
          <div className="card" style={{ width: "18rem" }}>
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                Get geared up at a local outdoor shop.
              </p>
              <a
                href={`/cities/${this.props.city.id}/outdoor-stores`}
                className="btn btn-primary"
              >
                See Outdoor Stores
              </a>
          ...
          <div className="card" style={{ width: "18rem" }}>
            ...
            <div className="card-body">
              ...
              <a
                href={`/cities/${this.props.city.id}/climbing-gyms`}
                className="btn btn-primary"
              >
                See Climbing Gyms
              </a>
